...
$$v_{NB} = \arg \max_{v_j \in V} P(v_j) \prod P(x_i|v_j)$$
...
- "Low Entropy" / "pure set" means $X$ is not uniform and interesting
  ...
  - $H(S) = - \frac{6}{6}\log_2\frac{6}{6} - \frac{0}{6}\log_2{0}{6} = 0$ (can be interpreted as 0 bits)
...
$$\alpha_i^*, ..., \alpha_m^* = \argmax_{\alpha_1, ..., \alpha_m} - \frac{1}{2}\sum_{i=1}^m \sum_{j=1}^m \alpha_i \alpha_j y_i y_j x_i \cdot x_j + \sum_{i=1}^m \alpha_i $$
