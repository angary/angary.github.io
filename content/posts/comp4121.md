...
If they can't communicate, then the above method will allow them to access the database with probabiltiy $1 - 1/n$ time, which is larger only by a relatively small factor of $2e \text{ln}n$.
